...
\hypersetup{
    ...
    pdfpagemode=UseOutlines,     % Open with bookmarks panel visible
...
\end{itemize}
These effects are localised: errors are largest in cells adjacent to the extraction boundary and decay rapidly with distance (see \cref{sec:accuracy-comparison}).
\end{notebox}
...
The library provides four approaches for applying boundary conditions on the extraction boundary (\texttt{oldInternalFaces}):
