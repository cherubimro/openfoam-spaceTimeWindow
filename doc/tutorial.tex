...
\begin{tikzpicture}[
    ...
    \node[font=\sffamily\small\bfseries, warningorange] at (10,0.5) {U,p,gradp.dvz};
...
\begin{tikzpicture}[
    ...
    \node[smallbox, fill=white, draw=primaryblue] at (0,6.1) {p.dvz, gradp.dvz};
...
7z a -m0=lzma2 -mx=9 ../boundaryData.7z */*.dvz */*.dvzt

# Or with zstd for faster compression
tar -cf - */*.dvz */*.dvzt | zstd -3 > ../boundaryData.tar.zst
\end{lstlisting}
